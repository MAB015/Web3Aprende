            ...
            <div className='flex flex-col gap-16 mt-16 w-1/2'>
                <Link to='/units' className='flex items-center gap-8'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <p className='text-xl font-montserrat'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse tempus gravida rutrum. Mauris egestas luctus euismod. </p>
                    </div>
                </Link>
